...
interface LtPanelsFormProps {
    onBack: () => void;
    onNext: () => void;
    isPending: boolean;
}

export function LtPanelsForm({ onBack, onNext, isPending }: LtPanelsFormProps) {
    const checklistItems: ChecklistItemProps[] = [
        {
            name: "installationOfPanels",
            title: "1. Installation of Panels as per Drawing",
            acceptanceCriteria: (
        ...
        {
            name: "markingAndDesignationOfPanels",
            title: "3. Marking/Designation of Panels",
            acceptanceCriteria: "Panel Should be properly marked/identified by paint."
        },
        {
            name: "connectionOfBusbar",
            title: "4. Connection of Busbar under panels",
             acceptanceCriteria: (
                <ul className="list-decimal list-inside">
                    <li>Busbar Joints should be properly checked for Tightness.</li>
                    <li>Busbar should be alligned properly.</li>
                </ul>
            )
        },
        {
            name: "earthingOfPanels",
            title: "5. Earthing of the Panels",
            acceptanceCriteria: (
                <ul className="list-decimal list-inside">
                    <li>Double Earthing to be done using earth strip/Wire.</li>
                    <li>Earthing continuity to be verified.</li>
                </ul>
            )
        },
        {
            name: "useOfCableGlands",
            title: "6. Use of Cable Glands",
            acceptanceCriteria: "Proper cable glands as per cable size should be used."
        },
        {
            name: "unusedHoles",
            title: "7. Unused Holes in the bottom of Panels",
            acceptanceCriteria: "Any Unused holes should be covered properly."
        },
        {
            name: "conditionOfGaskets",
            title: "8. Condition of Gaskets",
            acceptanceCriteria: "Panel Cover gaskets should be in good condition."
        },
        {
            name: "dressingOfCables",
            title: "9. Dressing of Control & Power Cables under Panel",
            acceptanceCriteria: (
                <ul className="list-decimal list-inside">
